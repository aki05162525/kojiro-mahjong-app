...
export default function CreateLeaguePage() {
  ...
  return (
    <div className="container mx-auto max-w-2xl py-8">
      <h1 className="text-2xl font-bold mb-6">リーグ作成</h1>
          ...
          <FormField
            ...
            render={({ field }) => (
              <FormItem>
                ...
                <FormControl>
                  <Input placeholder="例: 2025春季リーグ" {...field} />
                </FormControl>
                <FormDescription>
                  1〜20文字で入力してください
                </FormDescription>
...
### データテーブルの実装例（TanStack Table + shadcn/ui）

#### ファイル: `app/leagues/[id]/scores/page.tsx`
...
const mockScores: Score[] = [
  { playerId: '1', playerName: '田中太郎', score: 45000, rank: 1 },
  { playerId: '2', playerName: '佐藤花子', score: 32000, rank: 2 },
  { playerId: '3', playerName: '鈴木一郎', score: 18000, rank: 3 },
  { playerId: '4', playerName: '高橋次郎', score: 5000, rank: 4 },
]

export default function ScoresPage() {
  return (
    <div className="container mx-auto py-8">
      <h1 className="text-2xl font-bold mb-6">スコア表</h1>

      <Table>
        <TableCaption>第1節 スコア一覧</TableCaption>
        <TableHeader>
          <TableRow>
        ...
        <TableBody>
          {mockScores.map((score) => (
            <TableRow key={score.playerId}>
              <TableCell className="font-medium">{score.rank}位</TableCell>
...
**注意:**
- 上記は基本的なテーブル例
- ソート、フィルタリング、ページネーションが必要な場合は、別途TanStack Tableの実装が必要
- shadcn/uiには[Data Table](https://ui.shadcn.com/docs/components/data-table)のドキュメントあり
