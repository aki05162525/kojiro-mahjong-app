...
import type { LoginInput } from '@/src/schemas/auth'
...
/**
 * ログインフォームUI（Presentational Component）
 * ロジックを持たず、propsで受け取ったデータを表示するのみ
 */
export function LoginForm({ register, errors, error, loading, onSubmit }: LoginFormProps) {
  return (
